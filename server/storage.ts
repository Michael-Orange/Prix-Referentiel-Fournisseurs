  ...
  async getFournisseurs(includeInactifs?: boolean): Promise<FournisseurWithStats[]> {
    ...
    const results = await db
      .select({
        ...
        contact1: fournisseurs.contact1,
        telephone1: fournisseurs.telephone1,
        email1: fournisseurs.email1,
        contact2: fournisseurs.contact2,
        telephone2: fournisseurs.telephone2,
        email2: fournisseurs.email2,
        adresse: fournisseurs.adresse,
        localisationGoogleMaps: fournisseurs.localisationGoogleMaps,
